        ...
        <GridItem>
          <Flex className='flex-col base:justify-center base:items-center lg:justify-start lg:items-start '>
            <Text className='text-[#4823ec] base:!text-center base:mt-8 base:text-[26px] base:w-100% xss:text-[32px] xs:text-[42px] xs:p-4 sm:text-[50px] md:text-[60px]  lg:!text-left lg:text-[48px]  lg:w-[112%] font-semibold mt-20 3xl:mt-28 3xl:text-[80px] '>
              ...
              Operations with Our SeamLess Dashboard
            </Text>
            ...
            <Button className={`${
               ...
               <Text className="text-white 3xl:text-[32px]">Get Started</Text> 
            </Button>
          </Flex>
        </GridItem>
        <GridItem w={{base: '100%', lg:'140%', '2xl':'100%'}} className={'relative base:-left-10 base:-top-60 xss:-top-[19rem] base:-z-10  base:opacity-[0.2] sm:-top-96 md:-top-[30em]  lg:-left-60 lg:top-0 lg:opacity-100 xl:-top-4 xl:-left-80 3xl:top-0'} >
